const SearchIcon__Messages = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={15} height={15} fill="none" className="SearchIcon__Messages">
      <path
        fill="#3C3C43"
        fillOpacity={0.6}
        fillRule="evenodd"
...
export default SearchIcon__Messages;
